...
public class ImageUtil_FullImg {
    private int width;
    private int height;
...
/*
    public static void main(String[] args) {
        ImageTest2 is = new ImageTest2();
        try {
            is.saveImageAsJpg("D:/pics/20102210345698.jpg", "D:/pics/convert1.jpg", 100, 50);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    */
    ...
    public void saveImageAsJpg(FileItem f, String saveToFileStr,
