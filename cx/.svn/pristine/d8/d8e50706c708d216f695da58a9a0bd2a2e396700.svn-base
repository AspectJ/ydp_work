...
public class ActivityInfoDaoImpl extends SqlSessionDaoSupport{
	...
	public Map<String, Object> getActivity(Map<String, Object> Map){
		return getSqlSession().selectOne("activity.getActivity", Map);
	}
	...
	public List<Map<String, Object>> getActivityList(Map<String, Object> paramMap){
		return getSqlSession().selectList("activity.getActivityList", paramMap);
	}
	
	/**
	 * 查询最新活动总数量
	 */
	public int getActivityListCount(Map<String, Object> activityMap){
		return getSqlSession().selectOne("activity.getActivityListCount", activityMap);
	}
