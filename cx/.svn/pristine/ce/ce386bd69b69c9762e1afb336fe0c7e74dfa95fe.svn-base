...
* @author Jiangpin
*/
public class ImageUtil_WhiteImg {
	
	

	
    public void img_change(String url,String name,FileItem item,int width,int Height)
    {
            Tosmallerpic(url,item,"",name,width,Height,(float)0.7);
//            Tosmallerpic(url,item,"_small",name,45,45,(float)0.7);
//            Tosmallerpic(url,item,"_smaller",name,116,100,(float)0.7);
    }
/**
*
* @param f 图片所在的文件夹路径
...
* @param per 百分比
*/
    private static void  Tosmallerpic(String f,FileItem item,String ext,String n,int w,int h,float per){
            Image src;
            ...
            try {
                ...
                src = javax.imageio.ImageIO.read(input); //构造Image对象
