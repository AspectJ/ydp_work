...
class NoticeInfo extends Component {
    ...
    // 		const cityCateProps = {
    		...
    		this.props.handleUpdate({...stepPrevValue,info_id:this.props.contentItem.id});
    	}
    }
    //查询栏目
    findColumns = () => {
	...
	render(){
        ...
        <div className="ContentBody">
  	    	<div style={{height:'100px',paddingTop:'30px'}}>
  	    		<Steps current={this.state.steps} style={{width: '100%', padding: '0 10%'}}>
  	    	...
  	    	</div>
  		    {
  		    	...
  		    	(
  				    <div>
  		    		    <Form layout="horizontal" style={{width:'500px',marginTop:'20px',marginLeft:'10%'}}>
  		    		      <Row>
  		    		        <Col span={24}>
  		    		          <FormItem
  		    		            label="所属栏目:"
                          ...
                          extra="只能上传一张图片，建议图片尺寸：1190*90(像素)，新上传图片会覆盖之前图片"
  		    		          ...
  		    		          >
  		    		          	<Spin spinning={this.props.loading} tip="加载中..."  size="small">
                            {/*<div><a href={this.props.contentItem.pic_url}>{this.props.contentItem.image_name}</a></div>*/}
  			    		          	{
