...
import com.common.pinyin.PinyinHelper;
import com.common.pinyin.format.HanyuPinyinCaseType;
import com.common.pinyin.format.HanyuPinyinOutputFormat;
import com.common.pinyin.format.HanyuPinyinToneType;
import com.common.pinyin.format.HanyuPinyinVCharType;
 ...
 * </p>
 * <p>
 * Description：调用方式：SpellUtil.getFullSpell
 * </p>
 * <p>
 * Author :任托宇 2012-9-1
 * </p>
		...
		for (int i = 0; i < arr.length; i++) {
			if (arr[i] > 128) {
				try {
					...
					throw new DpException("拼音转换异常", e);
				}
			} else {
				pybf.append(arr[i]);
			}
