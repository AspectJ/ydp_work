...
import com.service.api.entity.ApiPayBox;
 ...
 */
@Component
public class ApiPayboxService extends BaseService implements IService {
	...
	private void index(Param pm, JSONObject obj) throws Exception {
		...
		try {
			...
			List<ApiPayBox> list = getDao().query("apipaybox.queryApiPayBox",
					map, ApiPayBox.class);
