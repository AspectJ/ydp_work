	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: 'js/plugin/progressbar/js/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'js/plugin/progressbar/js/images/progressbg_red.gif',
								30: 'js/plugin/progressbar/js/images/progressbg_orange.gif',
								70: 'js/plugin/progressbar/js/images/progressbg_green.gif'
