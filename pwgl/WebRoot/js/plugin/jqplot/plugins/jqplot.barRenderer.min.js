		...
		if (O) {
			...
			if (this.barDirection == "vertical") {
				for ( var I = 0; I < L.length; I++) {
					...
					// 如果渲染器中设置了使用多种颜色，则在渲染的时候用不同的颜色渲染
					if (this.rendererOptions.useMutliColor) {
						this._dataColors.push(sColors[colorCount]);
						this.renderer.shapeRenderer.strokeStyle = sColors[colorCount];
						this.renderer.shapeRenderer.fillStyle = sColors[colorCount];
						colorCount++;
