...
public class CinemaInfoRest extends BaseServlet
{
	...
	public String areaList(@Context HttpServletRequest request, @Context HttpServletResponse response){
	...
	public String cinemaList(@Context HttpServletRequest request, @Context HttpServletResponse response){
		...
		try
		{
			...
			{
				dataMessage = serviceCinema.xiaoxCityCinema(citycode);
			}else{
				dataMessage = serviceCinema.xiaoxCityCinema(null);
			}
			if (dataMessage.isSuccess())
			{
