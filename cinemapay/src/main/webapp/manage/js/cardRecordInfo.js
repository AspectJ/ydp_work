...
function loadData(side){
	...
	ajaxRequest("card/getChargeOffCardList", "GET", false, param, 
				...
				case 1000:
					...
					if(dataList != null && dataList.length > 0){
						for (var i=0; i<dataList.length; i++) {
							...
							dataJson.confcount = cardrecordinfo.confcount == 0 ? "--" : cardrecordinfo.confcount;
		...
		, null, function(){
			...
			if(status == 0){
				if(cardPer.indexOf("refundCard")>-1){
					table_head = '<tr><th>卡券名</th><th>类型</th><th>总次数</th><th>总面值</th><th>卡号</th><th>核销影院</th><th>核销人员</th><th>核销次数</th><th>核销面值</th><th>核销时间</th><th>操作</th></tr>';
				}else{
					table_head = '<tr><th>卡券名</th><th>类型</th><th>总次数</th><th>总面值</th><th>卡号</th><th>核销影院</th><th>核销人员</th><th>核销次数</th><th>核销面值</th><th>核销时间</th></tr>';
				}
			}else{
				table_head = '<tr><th>卡券名</th><th>类型</th><th>总次数</th><th>总面值</th><th>卡号</th><th>核销影院</th><th>核销人员</th><th>核销次数</th><th>核销面值</th><th>核销时间</th><th>退款时间</th></tr>';
			}
