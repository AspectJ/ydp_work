...
public class ConfCinemaDaoImpl extends BaseDao{
	 ...
	 * @return
	 */
	public Map<String, Object> getConfCinemaByCinemaid(Map<String, Object> paramMap){
		Map<String, Object> map = getSqlSession().selectOne("confCinema.getConfCinemaByCinemaid", paramMap);
		return map;
	}
}
